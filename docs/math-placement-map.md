...
| **A constant that is chosen** | `book8/ch8-8b-brown-dwarfs.html` §2–3 — T_c turns over | the 38% miss, and its four named causes | — | — | same `M_Pl^3/m_u^2`, but times a TEMPERATURE | **theorem vs convention — the pair is the finding** |
