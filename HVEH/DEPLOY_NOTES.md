...
### r* = 0.77594058 (canonical — chosen)
Propagate everywhere; the new chapters already use 0.77594058. Fix:
- **ch10.html** — body text, figure label, and Lean `r_star` all standardized to **0.77594058** (displayed 0.776). (Earlier drafts: 0.80 body, 0.8123 figure.)
- **ch03.html** — the two "r* ≈ 0.8" refs standardized to 0.77594058 (0.776).
- Anywhere the symmetric Gronwall 1/3 is described: keep ε₀ = 1/3 as the *outer* stability radius, r* ≈ 0.77594058 as the *inner* nonlinear boundary (the new chapters state it this way).
