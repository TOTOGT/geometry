...
\begin{itemize}
  ...
  \item Asymmetric Gronwall radius (fixed point of $G$): $r^* \approx 0.77594058$, certified by \texttt{certify\_rstar.py}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,keepaspectratio]{switzerland-2026-06-23.jpeg}
...
\bibitem{rstar} Grossi, P. N. (2026). \texttt{certify\_rstar.py} --- numerical certification of the asymmetric Gronwall radius $r^* \approx 0.77594058$. In Principia Orthogona Vol. II.
\end{thebibliography}
