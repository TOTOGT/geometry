# CLAUDE-ARCHIVE.md — closed defect ledger, totogt.github.io/geometry

Split out of `CLAUDE.md` on 2026-08-22. Every entry here is **closed**: fixed, resolved,
or a completed sweep. Nothing was reworded in the move.

Open residue from these entries was lifted into `CLAUDE.md` under
*Open items carried forward*, so this file asserts nothing that still needs doing.

Read one section on demand. Do not load this file at session start.
...
*(Open residue lifted to `CLAUDE.md` → Open items carried forward.)*
