...
\vspace{5mm}
\begin{center}\includegraphics[width=\linewidth]{fig_decay.pdf}\end{center}
...
\node[fill=navy,inner sep=9mm,text width=\dimexpr\linewidth-22mm\relax,rounded corners=2pt]{%
  ...
  {\fontsize{56}{60}\selectfont\bfseries $r_\star = 0.77594058$}\\[5mm]
...
\vspace{4mm}
\begin{center}\includegraphics[width=\linewidth]{fig_basin.pdf}\end{center}
\vspace{3mm}
\begin{center}\includegraphics[width=\linewidth]{fig_phase.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{fig_lambda.pdf}\end{center}
\vspace{3mm}
...
$r_\star = 0.77594058$ & certified numerically\\
