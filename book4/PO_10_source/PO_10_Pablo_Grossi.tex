...
%   1. r* : 0.80  ->  0.77594058   (certify_rstar.py, DOP853, 8 s.f.)
...
\fancyhead[L]{\raisebox{-0.35\height}{\includegraphics[height=34pt]{LogoXIIBienal.png}}}
\fancyhead[R]{\raisebox{-0.15\height}{\includegraphics[height=20pt]{UFRN2.png}}}
...
\begin{equation}
  r(0) \;>\; \rstar \;=\; 0.77594058 \qquad (\lambda = 2),
\end{equation}
