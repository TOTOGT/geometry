...
const CHAPTERS = [
  ...
  {id:'ch12',      short:'12', label:'Ch 12 · Fixed Pt', url:'ch12-conclusion.html',       op:'G', desc:'Banach fixed point. G(x*)=x*. You are the proof.'},
   {id:'ch13', short:'13', label:'Ch 13 · Revision', url:'ch13-revision.html', op:'U', desc:'Revision as annealing. The Nirvana Machine. Fixed-point cooling.'},
   {id:'ch14', short:'14', label:'Ch 14 · AXLE', url:'ch14-axle.html', op:'U', desc:'AXLE. The sorry-free paper. Proof without apology.'},
   {id:'ch15', short:'15', label:'Ch 15 · Entropy', url:'ch15-entropy.html', op:'U', desc:'Entropy and the compression circle. H and information.'},
   {id:'ch16', short:'16', label:'Ch 16 · Scale', url:'ch16-scale.html', op:'G', desc:'Scale invariance. The Mini-Beast. Self-similarity at every zoom.'},
