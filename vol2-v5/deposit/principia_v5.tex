...
$r^{*} = 0.77594058$ (rounded $\approx 0.776$), refining the placeholder value
...
\[
r^{*} = 0.77594058 \;\;\text{(rounded to 3 d.p.: } 0.776\text{)}.
\]
...
\begin{enumerate}
  ...
  \item \textbf{Gronwall Asymmetry (AXLE Issue \#13, closed numerically in V3).} The
        certification $r^{*} = 0.77594058$ (\S 4.7) establishes the inner-basin boundary
...
\begin{itemize}[leftmargin=2em]
  ...
  \item \textbf{V3 (June 2026, DOI 10.5281/zenodo.20755436):} certified inner-basin boundary $r^{*} = 0.77594058$ (\S 4.7); AXLE Issue \#13 closed; updated Lean status table; cosmetic edits.
