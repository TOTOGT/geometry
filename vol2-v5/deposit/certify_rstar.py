...
Zenodo  : see the record this file is deposited in.
          (A hardcoded version DOI was removed 2026-08-26: five copies of this
           script existed in two variants differing only in that line, and both
           named a Volume I DOI. A script that welds a version DOI into itself
           goes stale on the next deposit.)
License : MIT
...
def main():
    ...
    print("  DOI: see the deposit record for this file")
    print("=" * 62)
    print()
    print("  System:")
